...
greet();
// TIPOS DE VARIABLES:
var variableGlobal: number = 8;
console.log("vG:", variableGlobal);
let variableLocal: boolean = true;
console.log("vL:", variableLocal);
const profile: string = "SOFTWARE_ENGINEER";
console.log(profile);
...
const var2: number = -7;
let cocienteEntero: number;
// Siempre al valor inferior (-∞)
cocienteEntero = Math.floor(var2 / 3);
console.log(
  `Parte entera de una división(1)-piso: ${var2} / 3 = ${cocienteEntero}`
);
// siempre hacia arriba
cocienteEntero = Math.ceil(var2 / 3);
console.log(
  `Parte entera de una división(1)-techo: ${var2} / 3 = ${cocienteEntero}`
);
