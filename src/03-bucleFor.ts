const cardFooter = document.querySelector(".card-footer") as HTMLElement;
const limitInput = document.getElementById("limitInput") as HTMLInputElement;
const limitInputHelp = document.getElementById(
  "limitInputHelp"
) as HTMLParagraphElement;
const skipInputHelp = document.getElementById(
  "skipInputHelp"
) as HTMLParagraphElement;
